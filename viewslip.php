...
if ($userlevel == '1') {
$sql = "select *, s.emptypeid AS semptypeid  from slip s
...
//echo "sql = $sql <br> result = $result<Br>";
	...
	$emptypeid = $rows["semptypeid"];
		...
		case "1":
			$typename = 'ข้าราชการ';
			$headname = 'ใบรับรองการจ่ายเงินเดือนและเงินอื่น';
			$headmoney ='รายการรายรับ';
		...
		case "2":
			...
			$headname = 'ใบรับรองการจ่ายค่าจ้างและเงินอื่น';
			$headmoney ='รายการรายรับ';
			$headsummoney ='รวมรับทั้งเดือน';
			$headexp = 'รายการรายจ่าย';
			$headsumexp = 'รวมจ่ายทั้งเดือน';
		...
		case "3":
			...
			$headname = 'ใบรับรองการจ่ายค่าจ้าง';
			$headmoney ='รายการค่าจ้าง';
			$headsummoney ='รวมรายการค่าจ้าง';
			$headexp = 'รายการรายจ่าย';
			$headsumexp = 'รวมรายการหัก';
			$headall =  'รวมจำนวนทั้งหมด';
			break;
		case "4":
...
$exp_text21 = $rows["exp_text21"];
$exp_text22 = $rows["exp_text22"];
$exp_text23 = $rows["exp_text23"];
$exp_text24 = $rows["exp_text24"];
$exp_text25 = $rows["exp_text25"];
...
<tr bgcolor=white ><td style='padding: 15px;'> 
	...
	<td><font color=#000>&nbsp;&nbsp;&nbsp;$headname $typename (สถาบันโรคทรวงอก) ประจำเดือน $monthname $yy5 </td>
	...
	&nbsp;&nbsp;&nbsp;หน่วยงาน &nbsp;&nbsp;:&nbsp;&nbsp; $depart
	<Br>&nbsp;&nbsp;&nbsp;$bankid&nbsp;&nbsp; เลขที่บัญชี :&nbsp;$bankno
	</td>
";


echo"	<td rowspan=3><center><A href='viewslipprint.php?id=$enc'><img src='img/printer.png'><Br> พิมพ์สลิป</a></td>";
...
<tr bgcolor=white >
<td style='padding: 15px;'><font color=#000><u>รายละเอียด</u></font><Br>
...
<Td width=50%>
	<table width=100%>
	<tr>
	<td width=50%><font color=#000><u>$headexp</u></td>
...
if ($exp_text21 <> '' ) { 
	$exp21=number_format($exp21 , 2 );
	echo " 	
	<tr>
	<td width=50%><font color=#000>$exp_text21</td>
	<td width=50% align=right><font color=#000>$exp21</td>
	</tr>
	";
}

if ($exp_text22 <> '' ) { 
	$exp22=number_format($exp22 , 2 );
	echo " 	
	<tr>
	<td width=50%><font color=#000>$exp_text22</td>
	<td width=50% align=right><font color=#000>$exp22</td>
	</tr>
	";
}

if ($exp_text23 <> '' ) { 
	$exp23=number_format($exp23 , 2 );
	echo " 	
	<tr>
	<td width=50%><font color=#000>$exp_text23</td>
	<td width=50% align=right><font color=#000>$exp23</td>
	</tr>
	";
}

if ($exp_text24 <> '' ) { 
	$exp24=number_format($exp24 , 2 );
	echo " 	
	<tr>
	<td width=50%><font color=#000>$exp_text24</td>
	<td width=50% align=right><font color=#000>$exp24</td>
	</tr>
	";
}
...
if ($exp_text25 <> '' ) { 
	$exp25=number_format($exp25 , 2 );
	echo " 	
	<tr>
	<td width=50%><font color=#000>$exp_text25</td>
	<td width=50% align=right><font color=#000>$exp25</td>
	</tr>
	";
}
...
echo"
	...
	<tr>
	<td width=50%><font color=#000>$headsumexp</td>
...
<tr valign=bottom  >
<td align=right ></td>
<td ><font color=#000><center>( $datepay2 )</center></td>
<td></td>
</tr>
...
<tr valign=bottom  >
<td align=right ></td>
<td ><font color=#000><center>วัน เดือน ปี ที่ออกหนังสือรับรอง</center></td>
<td></td>
</tr>
