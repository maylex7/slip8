...
global $Lfirst,$Lprevious,$Lnext ,$Llast ,$type;

//if (($total_item == '' ) or ($total_item =='0')) { $total_item ='1'; }
//echo "total_item = $total_item <Br> per_page = $per_page <br>";
$per_page=10;
...
$mark_char = ($query_str!="")?"&":"?";
  echo '<nav>
      <ul class="pagination justify-content-center">
        <li class="page-item">
        <a class="page-link" href="'.$query_str.$mark_char.'page=1&type='.$type.'"> First</a>
        </li>
        ';
    echo '
        <li class="page-item '.(($cur_page==1)?"disabled":"").'">
          <a class="page-link"  href="'.$query_str.$mark_char.'page='.$prev_page.'&type='.$type.'"> Previous</a> 
        </li> 
    ';  
    for($i = $f_num_page; $i<=$show_page;$i++){
    echo '     
        <li class="page-item '.(($i==$cur_page)?"active":"").'"> 
          <a class="page-link" href="'.$query_str.$mark_char.'page='.$i.'&type='.$type.'"> '.$i.' </a> 
        </li>     
    ';
    }
    echo '
        <li class="page-item '.(($next_page>$total_page)?"disabled":"").'"> 
            <a class="page-link"  href="'.$query_str.$mark_char.'page='.$next_page.'&type='.$type.'"> Next</a> 
        </li>     
    ';  
    echo '
        <li class="page-item">
    ...
    echo '
        <li class="page-item"> 
            <a class="page-link"  href="'.$query_str.$mark_char.'page='.$total_page.'&type='.$type.'"> Last</a> 
        </li>     
      </ul>
    </nav>        
    ';    
