...
if($input_file_name=="")
	...
	{
	exit("<script>alert('กรุณาแนบไฟล์ excel เท่านั้น');window.location='../importdata.php?type=4';</script>");
	}	
...
if ($action == '4' ) { 
	...
	/*Slip*/
	$money1    = $worksheet->getCell('G'.$row)->getCalculatedValue();
	$money2    = $worksheet->getCell('H'.$row)->getCalculatedValue();
	$money3    = $worksheet->getCell('I'.$row)->getCalculatedValue();
	$money4    = $worksheet->getCell('J'.$row)->getCalculatedValue();
	$money5    = '';
	...
	$exp1    = $worksheet->getCell('K'.$row)->getCalculatedValue();
	$exp2    = $worksheet->getCell('L'.$row)->getCalculatedValue();
	$exp3    = $worksheet->getCell('M'.$row)->getCalculatedValue();
	$exp4    = $worksheet->getCell('N'.$row)->getCalculatedValue();
	$exp5    = $worksheet->getCell('O'.$row)->getCalculatedValue();
	$exp6    = $worksheet->getCell('P'.$row)->getCalculatedValue();
	$exp7    = $worksheet->getCell('Q'.$row)->getCalculatedValue();
	$exp8    = $worksheet->getCell('R'.$row)->getCalculatedValue();
	$exp9    = $worksheet->getCell('S'.$row)->getCalculatedValue();
	$exp10    = $worksheet->getCell('T'.$row)->getCalculatedValue();
	$exp11    = $worksheet->getCell('U'.$row)->getCalculatedValue();
	$exp12    = $worksheet->getCell('V'.$row)->getCalculatedValue();
	$exp13    = $worksheet->getCell('W'.$row)->getCalculatedValue();
	$exp14    = $worksheet->getCell('XX'.$row)->getCalculatedValue();
	$exp15    = $worksheet->getCell('XX'.$row)->getCalculatedValue();
	$exp16    ="";
	$exp17    ="";
	$exp18    ="";
	$exp19    ="";
...
//echo "idno11  = $idno ,position = $position, department= $department <Br>";
	...
	$exp1    = $worksheet->getCell('I'.$row)->getCalculatedValue();
	$exp2    = $worksheet->getCell('J'.$row)->getCalculatedValue();
	$exp3    = $worksheet->getCell('K'.$row)->getCalculatedValue();
	$exp4    = $worksheet->getCell('AL'.$row)->getCalculatedValue();
	$exp5    = $worksheet->getCell('AL'.$row)->getCalculatedValue();
...
//echo "idno11  = $idno ,position = $position, department= $department <Br>";
   ...
   //echo "m1 = $money1 <Br>";
	...
	$exp1    = $worksheet->getCell('M'.$row)->getCalculatedValue();
	$exp2    = $worksheet->getCell('N'.$row)->getCalculatedValue();
	$exp3    = $worksheet->getCell('O'.$row)->getCalculatedValue();
	$exp4    = $worksheet->getCell('P'.$row)->getCalculatedValue();
	$exp5    = $worksheet->getCell('Q'.$row)->getCalculatedValue();
	$exp6    = $worksheet->getCell('R'.$row)->getCalculatedValue();
	$exp7    = $worksheet->getCell('S'.$row)->getCalculatedValue();
	$exp8    = $worksheet->getCell('T'.$row)->getCalculatedValue();
	$exp9    = $worksheet->getCell('U'.$row)->getCalculatedValue();
	$exp10   = $worksheet->getCell('V'.$row)->getCalculatedValue();
	$exp11   = $worksheet->getCell('W'.$row)->getCalculatedValue();
	//$exp11 = $worksheet->getCell('W')->getCalculatedValue();
	$exp12    = $worksheet->getCell('X'.$row)->getCalculatedValue();
	$exp13    = $worksheet->getCell('Y'.$row)->getCalculatedValue();
	$exp14    = $worksheet->getCell('AL'.$row)->getCalculatedValue();
	$exp15    = $worksheet->getCell('AL'.$row)->getCalculatedValue();
	$exp16    ="";
	$exp17    ="";
...
//echo "idno11  = $idno ,position = $position, department= $department <Br>";
	...
	$money3    = $worksheet->getCell('J'.$row)->getCalculatedValue();
	$money4    = $worksheet->getCell('K'.$row)->getCalculatedValue();
	$money5    = $worksheet->getCell('L'.$row)->getCalculatedValue();
	$money6    = $worksheet->getCell('M'.$row)->getCalculatedValue();
	$money7    = $worksheet->getCell('N'.$row)->getCalculatedValue();
	$money8    = $worksheet->getCell('O'.$row)->getCalculatedValue();
	$money9    = $worksheet->getCell('P'.$row)->getCalculatedValue();
	$money10  = $worksheet->getCell('Q'.$row)->getCalculatedValue();
	$money11 = $worksheet->getCell('R'.$row)->getCalculatedValue();
	$money12 = $worksheet->getCell('S'.$row)->getCalculatedValue();
	$money13 = $worksheet->getCell('T'.$row)->getCalculatedValue();
	$money14 = "";
	$money15 = "";
	...
	$exp1    = $worksheet->getCell('V'.$row)->getCalculatedValue();
	$exp2    = $worksheet->getCell('W'.$row)->getCalculatedValue();
	$exp3    = $worksheet->getCell('X'.$row)->getCalculatedValue();
	$exp4    = $worksheet->getCell('Y'.$row)->getCalculatedValue();
	$exp5    = $worksheet->getCell('Z'.$row)->getCalculatedValue();
	$exp6    = $worksheet->getCell('AA'.$row)->getCalculatedValue();
	$exp7    = $worksheet->getCell('AB'.$row)->getCalculatedValue();
	$exp8    = $worksheet->getCell('AC'.$row)->getCalculatedValue();
	$exp9    = $worksheet->getCell('AD'.$row)->getCalculatedValue();
	$exp10   = $worksheet->getCell('AE'.$row)->getCalculatedValue();
	$exp11   = $worksheet->getCell('AF'.$row)->getCalculatedValue();
	$exp12    = $worksheet->getCell('AG'.$row)->getCalculatedValue();
	$exp13    = $worksheet->getCell('AH'.$row)->getCalculatedValue();
	$exp14    = $worksheet->getCell('AI'.$row)->getCalculatedValue();
	$exp15    = $worksheet->getCell('AJ'.$row)->getCalculatedValue();
	$exp16    = $worksheet->getCell('AK'.$row)->getCalculatedValue();
	$exp17    = $worksheet->getCell('AL'.$row)->getCalculatedValue();
	$exp18    = $worksheet->getCell('AM'.$row)->getCalculatedValue();
	$exp19    = $worksheet->getCell('AN'.$row)->getCalculatedValue();
	$exp20    = $worksheet->getCell('AO'.$row)->getCalculatedValue();
...
if ($action == '6' ) { 
	...
	$exp2    = $worksheet->getCell('J'.$row)->getCalculatedValue();
	$exp3    = $worksheet->getCell('K'.$row)->getCalculatedValue();
	$exp4    = $worksheet->getCell('L'.$row)->getCalculatedValue();
	$exp5    = $worksheet->getCell('M'.$row)->getCalculatedValue();
	$exp6    = $worksheet->getCell('N'.$row)->getCalculatedValue();
	$exp7    = $worksheet->getCell('O'.$row)->getCalculatedValue();
	$exp8    = $worksheet->getCell('P'.$row)->getCalculatedValue();
	$exp9    = $worksheet->getCell('Q'.$row)->getCalculatedValue();
	$exp10    = $worksheet->getCell('R'.$row)->getCalculatedValue();
	$exp11    = $worksheet->getCell('S'.$row)->getCalculatedValue();
	$exp12    = $worksheet->getCell('T'.$row)->getCalculatedValue();
	$exp13    = "";
	$exp14    = "";
	$exp15    = "";
	$exp16    ="";
...
$sql_s = "select *from slip where empid = '$empid' and yy='$yy5' and mm = '$mm5'   ";
$result_s = mysql_query($sql_s);
$num_s = mysql_num_rows($result_s);
...
if ($num_s == '0') {
		...
		,exp16,exp17,exp18,exp19,exp20
		,exp_text1,exp_text2,exp_text3,exp_text4,exp_text5,exp_text6,exp_text7,exp_text8,exp_text9,exp_text10,exp_text11,exp_text12,exp_text13,exp_text14,exp_text15,exp_text16,exp_text17,exp_text18,exp_text19,exp_text20,summoney,sumexp,sumnet,notes,remarks,invalid_flag,create_user,create_date,create_time,update_user,update_date,update_time)
		...
		,'$money_text1','$money_text2','$money_text3','$money_text4','$money_text5','$money_text6','$money_text7','$money_text8','$money_text9','$money_text10','$money_text11','$money_text12','$money_text13','$money_text14','$money_text15','$exp1','$exp2','$exp3','$exp4','$exp5','$exp6','$exp7','$exp8','$exp9','$exp10','$exp11','$exp12','$exp13','$exp14','$exp15','$exp16','$exp17','$exp18','$exp19','$exp20','$exp_text1','$exp_text2','$exp_text3','$exp_text4','$exp_text5','$exp_text6','$exp_text7','$exp_text8','$exp_text9','$exp_text10','$exp_text11','$exp_text12','$exp_text13','$exp_text14','$exp_text15','$exp_text16','$exp_text17','$exp_text18','$exp_text19','$exp_text20','$summoney','$sumexp','$sumnet','','','0','$suserid','$dates','$times','$suserid','$dates','$times')
...
//echo "slip same <Br>";
		...
		exp16='$exp16',exp17='$exp17',exp18='$exp18',exp19='$exp19',exp20='$exp20',
		...
		exp_text16='$exp_text16',exp_text17='$exp_text17',exp_text18='$exp_text18',exp_text19='$exp_text19',exp_text20='$exp_text20',
